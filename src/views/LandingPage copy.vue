...
section#section.intro
    .container 
        ...
        a(href='https://docs.skapi.com' target="_blank")
            img.btnImg(src="@/assets/img/Asset6.svg")
            .cont
                span Get Started
                img.arrowImg(src="@/assets/img/arrow_right.svg")
        //- a(href='https://docs.skapi.com' target="_blank")
        //-     img.btnImg(src="@/assets/img/icons/Asset6.svg")
        //-     span Get Started
        //-     img.arrowImg(src="@/assets/img/icons/arrow_right.svg")
        img.mainImg(src="@/assets/img/main_illu.svg" style="pointer-events: none;")
...
section#section.features 
    .container 
        ...
        .cardWrap 
            .card 
                .icon
                    img(src="@/assets/img/Serverless.svg")
                h4.tit Serverless
            ...
            .card 
                .icon
                    img(src="@/assets/img/Authentication.png")
            ...
            .card 
                .icon
                    img(src="@/assets/img/landing_page_html_logo.png")
...
#section {
            ...
            .desc {
                ...
                a {
                    button {
                        ...
                        background: #293FE6;
                        box-shadow: 1px 1px 2px 0px rgba(255, 255, 255, 0.65) inset, -1px -1px 2px 0px rgba(0, 0, 0, 0.25) inset;
                        cursor: pointer;
                    }
                }
            }
    ...
    &.signup {
        ...
        // height: 375px;
        padding: 100px 0;
        background: url("@/assets/img/Asset 33.png") no-repeat center;
